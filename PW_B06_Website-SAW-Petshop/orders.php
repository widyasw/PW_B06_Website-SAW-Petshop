...
<section class="placed-orders">
   <h1 class="title">pesanan yang masuk</h1>
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <p> dilakukan pada : <span><?php echo $fetch_orders['placed_on']; ?></span> </p>
         ...
         <p> status pembayaran : <span style="color:<?php if($fetch_orders['payment_status'] == 'menunggu'){ echo 'red'; }else{ echo 'green'; } ?>;"><?php echo $fetch_orders['payment_status']; ?></span> </p>
         </div>
      <?php
       }
      }else{
